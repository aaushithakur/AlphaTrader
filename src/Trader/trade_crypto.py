...
from server.mongo import get_users

user_rh = get_users()[0]

API_KEY = user_rh['constants']['API_KEY']  
BASE64_PRIVATE_KEY = user_rh['constants']['API_SECRET'] 
...
#     #       "market",
#     #       "BTC-USD",
#     #       {"asset_quantity": "0.0006"}
#     # )

#     # bid_ask = api_trading_client.get_best_bid_ask('BTC-USD')
#     # print(bid_ask)
#     # print(float(bid_ask['results'][0]['price']))
